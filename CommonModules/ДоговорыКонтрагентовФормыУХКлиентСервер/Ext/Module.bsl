...
Процедура АЛФ_УправлениеФормой_ВерсияСоглашенияКоммерческийДоговор(Форма)
	...
	Элементы.ГруппаКоридор.Видимость = (НЕ ЭтоФиксированныйКурс	И НЕ ОпределяетсяВЗаявке);
...
#КонецУдаления
	...
	Элементы.УсловиеОплаты.Видимость = ЭтоСПоставщиком ИЛИ ЭтоСПокупателем ИЛИ ЭтоСКомиссионером ИЛИ ЭтоСКомитентом;
