...
Функция АЛФ_ВернутьСтруктуруСсылокПоКлючам(СписокКлючей)
...
#Вставка
	...
	//ЭлементТаблицыФормы = Элементы.Добавить("ТекущиеОповещенияСписокПричинаВозврата", Тип("ПолеФормы"), Элементы.ТекущиеОповещенияСписок);
	//ЭлементТаблицыФормы.Заголовок = "Причина возврата"; 
	//ЭлементТаблицыФормы.Вид = ВидПоляФормы.ПолеНадписи;
	//ЭлементТаблицыФормы.ПутьКДанным = "МоиОповещения.ПричинаВозврата";

	//ЭлементТаблицыФормы = Элементы.Добавить("ТекущиеОповещенияСписокСумма", Тип("ПолеФормы"), Элементы.ТекущиеОповещенияСписок);
	//ЭлементТаблицыФормы.Заголовок = "Сумма"; 
	//ЭлементТаблицыФормы.Вид = ВидПоляФормы.ПолеНадписи; 
	//ЭлементТаблицыФормы.Формат = "ЧЦ=15; ЧДЦ=2";
	//ЭлементТаблицыФормы.ПутьКДанным = "МоиОповещения.Сумма"; 
