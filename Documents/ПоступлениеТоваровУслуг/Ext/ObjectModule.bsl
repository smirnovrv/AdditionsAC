...
Процедура АЛФ_ОбработкаПроведения(Отказ, РежимПроведения) 
	...
	Для Каждого СтрокаСопост Из СопоставленныеТовары Цикл
		...
		Движение.Период 					= Дата;
		Движение.Номенклатура 				= СтрокаСопост.Номенклатура;
		...
		Характеристика = ИИТ_ВспомогательныеФункцииСервер.ПолучитьХарактеристикуНоменклатурыСправочник(СтрокаСопост);
