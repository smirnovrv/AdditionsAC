...
#КонецВставки	
	...
	//СмирновРВ 
	Элементы.Переместить(Элементы.ГруппаВалютаОплаты		, НоваяГруппа);
	Элементы.Переместить(Элементы.ГруппаРучногоКурса		, НоваяГруппа);
	Элементы.Переместить(Элементы.ГруппаИтогоКОплате		, НоваяГруппа);	
