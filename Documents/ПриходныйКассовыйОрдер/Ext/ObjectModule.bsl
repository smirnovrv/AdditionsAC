...
Процедура АЛФ_ОбработкаПроведения(Отказ, Режим)  
	...
	Для Каждого СтрокаРасшифровки ИЗ РасшифровкаПлатежа Цикл
		...
		ДвижениеАС = Движения.АС_СменаФормы.ДобавитьРасход();  
		...
		ДвижениеАС.МОЛ 				= Справочники.ФизическиеЛица.НайтиПоНаименованию(ПринятоОт, Истина);;
		ДвижениеАС.СуммаКПолучению  = СтрокаРасшифровки.СуммаВзаиморасчетов; 
		//СмирновРВ
